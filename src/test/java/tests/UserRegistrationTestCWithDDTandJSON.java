...
public class UserRegistrationTestCWithDDTandJSON 
{
	WebDriver driver;
	...
	void UserCanRegisterSuccessFully() throws CsvValidationException, IOException, ParseException
	{
			...
			UReg.Register(jsonReader.fname, jsonReader.lname, jsonReader.email, jsonReader.pwd);
			...
			//Login
			homeP.OpenLoginPage();
			LoginP.Login(jsonReader.email, jsonReader.pwd);
